...
public class SocialNetwork {
	...
	/**
	 * Método que muestra por pantalla todos los posts en HTML.
	 * @param out
	 */
	public void listHtml(PrintStream out) {
		
		List<String> htmlList = toHtmlFormat();
		
		for(String post: htmlList) {
			out.println(post);
		}
	...
	/**
	 * Método que devuelve una lista con los posts en formato HTML.
	 */
