...
public class UserInterface {
	...
	private void processOption(int option) throws NewsstandException, FileNotFoundException {
		switch( option ) {
			...
			case 9: sortPublicationsByName(); break;
			case 10: sortPublicationsBySales(); break;
			case 11: sortOrdersByNameAndQuantity(); break;
		}
	}

	private void sortOrdersByNameAndQuantity() {
		newsStand.sortOrdersByNameAndQuantity();
	}

	private void sortPublicationsBySales() {
		newsStand.sortPublicationsBySales();
	}

	private void sortPublicationsByName() {
		
		newsStand.sortPublicationsByName();
